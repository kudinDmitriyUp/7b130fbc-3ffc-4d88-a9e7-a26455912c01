...
export const metadata: Metadata = {
  title: "Guglielmo Noya | Executive Leader in Global Telecom & ICT",
  description: "Senior executive with 30+ years leading strategic transformation in telecom and ICT across Europe, USA, and Latin America. Expertise in M&A, corporate finance, and business development.",
  keywords: ["executive", "telecom", "ICT", "M&A", "business leader", "Latin America", "corporate finance"],
  openGraph: {
    title: "Guglielmo Noya | Executive Leader",
    description: "30+ years driving strategic transformation in global telecom and ICT.",
    siteName: "Guglielmo Noya",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764607732213-xkldobbk.jpg",
      alt: "Guglielmo Noya Executive Portrait"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Guglielmo Noya | Executive Leader",
    description: "Senior executive with 30+ years in global telecom and ICT leadership",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764607732213-xkldobbk.jpg"]
  }
};
